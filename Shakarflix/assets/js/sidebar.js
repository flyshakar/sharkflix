...
export function sidebar(){
  ...
  <div class="sidebar-footer">
    <p class="copyright"><a href="#">Made with shakar</a>
    </p>
    <div class="social-link">
    <a href="https://twitter.com/flyshakar" alt="Social handles" target="_blank">Twitter</a>
    <a href="https://github.com/flyshakar" alt="Social handles" target="_blank">Github</a>
    <a href="https://www.instagram.com/fly_shakar/" alt="Social handles" target="_blank">Instagram</a>
    </div>
  </div>
`;
